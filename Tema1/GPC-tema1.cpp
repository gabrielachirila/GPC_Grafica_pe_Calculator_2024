...
void Display8() {
    ...
    // 
      ...
      //    double x = 0.4 * cos(angle);
      //    double y = 0.4 * sin(angle);
      //    printf("Coordonatele punctului %d: (%lf, %lf)\n", i + 1, x, y);
      //    glVertex2f(x, y);
      //}
      //glEnd();

    glColor3f(0.1, 0.1, 1.0); // red
    //glBegin(GL_POLYGON);
    //glVertex2f(0.500000, 0.000000);
    //glVertex2f(0.250000, -0.433013);
    //glVertex2f(-0.250000, -0.433013);
    //glVertex2f(-0.500000, 0.000000);
    //glVertex2f(-0.250000, 0.433013);
    //glVertex2f(0.250000, 0.433013);
    ...
    for (int i = 5; i >= 0; i--) {
        double angle = 2 * M_PI * i / 6;
        double x = 0.6 * cos(angle);
        double y = 0.6 * sin(angle);
        printf("Coordonatele punctului %d: (%lf, %lf)\n", i + 1, x, y);
        glVertex2f(x, y);
    }
    glEnd();
    ...
    for (int i = 5; i >= 0; i--) {
        double angle = 2 * M_PI * i / 6;
        double x = 0.38 * cos(angle);
        double y = 0.38 * sin(angle);
        printf("Coordonatele punctului %d: (%lf, %lf)\n", i + 1, x, y);
        glVertex2f(x, y);
    }
    glEnd();
